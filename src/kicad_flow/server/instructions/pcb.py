...
PCB = (
    ...
    "route. Then `add_outlines` for the board edge.\n"
    ...
    "5. Copper: each item in `add_tracks` is ONE straight segment on ONE layer, so a "
    ...
    "them. `add_board_texts` puts legends or fab notes on any layer -- "
